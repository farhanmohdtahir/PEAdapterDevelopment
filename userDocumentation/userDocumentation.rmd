...
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-l       |Minimum length percentage to get adapter sequence \        |OPTIONAL    |
...
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-m       |Minimum match percentage to get adapter sequence \         |OPTIONAL    |
|         | _This parameter will set the percentage's limit of_ \     |            |
...
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-c       |Minimum confidence level of nucleotides\                   |OPTIONAL    |
