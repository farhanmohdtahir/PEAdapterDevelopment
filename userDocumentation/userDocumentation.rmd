---
title: "PEAdapterFinder"
author: "This Documentation is Generated via Rmarkdown"
date: "Jan 3rd 2017"
output: pdf_document
---
...
3. Go to Downloads directory (or directory which the PEAdapterFinder-master.zip are located)  
    Example:  
    If Downloads directory is located in path: __/export/home/farhan/Downloads__  
...
2. Write the command to go to the directory that locate the PEAdapterFinder program  
    Example:  
    If PEAdapterFinder program is located in path: __/export/home/farhan/Downloads/PEAdapterFinder-master__:
...
+=========+===========================================================+============+
| -f1     |Input File 1. The file must in .fastq OR .fq file format\  |__REQUIRED__|
|         |(multi-line OR 4-line FASTQ file). \                       |            |
|         |Example: __-f1 _sample1.fastq___ OR __-f1 _sample1.fq___   |            |
+---------+-----------------------------------------------------------+------------+
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-f2      |Input File 2. The file must in .fastq OR .fq file format\  |__REQUIRED__|
|         |(multi-line OR 4-line FASTQ file). \                       |            |
|         |Example: __-f2 _sample2.fastq___ OR  __-f2 _sample2.fq___  |            |
+---------+-----------------------------------------------------------+------------+
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-seql    |Minimum length percentage to get adapter sequence \        |OPTIONAL    |
|         | _This parameter will set the percentage's limit of_ \     |            |          
|         | _length of sequence alignment for both read to determine_\|            |
|         | _whether both read contain Adapter Sequence or not._ \    |            |
|         |(Default = 70, to change use '-seql=')\                    |            |
|         |Example: __-seql=80__                                      |            |
+---------+-----------------------------------------------------------+------------+
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-perc    |Minimum match percentage to get adapter sequence \         |OPTIONAL    |
|         | _This parameter will set the percentage's limit of_ \     |            |
|         | _match bases between sequence alignment in read 1 and_\   |            |
|         | _read 2 to determine whether both read contain Adapter_\  |            |
|         | _Sequence or not._ \                                      |            |
|         |(default = 85, to change use '-perc=')\                    |            |
|         |Example: __-perc=90__                                      |            |
+---------+-----------------------------------------------------------+------------+
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-conf    |Minimum confidence level of nucleotides\                   |OPTIONAL    |
|         | _This parameter will set the limit of biggest phred_\     |            |
|         | _score for each bases in the adapter sequence that_\      |            |
|         | _allowed in order to determine the confidence level_\     |            |
|         | _of Adapter Sequence_\                                    |            |
|         |(default = 1, to change use '-conf=')  \                   |            |
|         |Example: __-conf=5__                                       |            |
+---------+-----------------------------------------------------------+------------+
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
|-debug   |Debug level of programme (default = 0, to change use\      |OPTIONAL    |  
|         |'-debug=' : \                                              |            |
|         |0 - only adapter sequences, \                              |            |
|         |1 - nucleotide count and phred score, \                    |            |
|         |2 - dynamic programming matrix and traceback matrix)  \    |            |
|         |Example: __-debug=1__ OR __-debug=2__                      |            |
+---------+-----------------------------------------------------------+------------+
|         |                                                           |            |
+---------+-----------------------------------------------------------+------------+
...
# Set the PEAdapterFinder program in your linux environment  
# [OPTIONAL]
